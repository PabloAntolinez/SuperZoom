...
if __name__ == '__main__':
	...
	print("initPygame")   # j'ai du deplacer cette methode dans le main car il me donnait une erreur comme quoi il ne connaissait pas : windowSurface !!! Tres louche ... 
	pygame.init()
	#windowSurface = pygame.display.set_mode((SCREENW, SCREENH), pygame.NOFRAME | pygame.FULLSCREEN)
	#windowSurface = pygame.display.set_mode((0, 0), pygame.NOFRAME | pygame.FULLSCREEN)
	...
	while not finished:
		...
		if multilight == 1 :
			...
			MultiLightAcq()  #collage est passe en global pour eviter une copie
			reAcquire = False
